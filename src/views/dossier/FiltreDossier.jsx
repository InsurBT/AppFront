...
export default function FiltreDossier(props) {
    ...
    <CardContent >
          ...
          <Grid item xs={3}>
            ...
            <Grid item xs ={6}> <input type='checkbox'  checked={checkedReception}
             onChange={(event) => {setCheckedReception(event.target.checked);}}/> Date Réception </Grid>
